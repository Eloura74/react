...
const Navbar = ({ accueilOnClick }) => {
  return (
    <nav className="navbarBg relative flex items-center justify-start h-36 shadow-lg">
      <div className="flex items-center gap-8 px-6 relative z-10">
        ...
        >
          ...
          />
          <a href="/" className="text-2xl text-white font-semibold hoverBtn">
            Accueil
          </a>
        </Link>
        ...
        <svg
          onClick={accueilOnClick}
          className="rounded-full cursor-pointer gap-12 ml-8 mt-8 hoverBtn"
          width="40px"
          height="40px"
          viewBox="0 0 24 24"
